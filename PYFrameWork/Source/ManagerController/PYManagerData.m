...
CGRect PYMangerControllerForIOS7WindowsBounds(){
    ...
    if (!IOS8_OR_LATER) {
        if ([PYOrientationNotification instanceSingle].interfaceOrientation == UIInterfaceOrientationLandscapeLeft
            || [PYOrientationNotification instanceSingle].interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
