...
-(void) setMenuStyle:(NSArray<NSDictionary *> *)menuStyle maxHeight:(CGFloat) maxHeight{
    ...
    for (NSDictionary * style in menuStyle) {
        ...
        UIImage * imageNormal = [UIImage createImageWithTitle:title font:font color:color image:image offH:5 imageOffH:imageOffH direction:imgDirection.boolValue];
        ...
        imageOffH = 0;
        if(maxHeight > 0) imageOffH = maxHeight - image.size.height;
        UIImage * imageHigthlight = [UIImage createImageWithTitle:title font:font color:color image:image offH:5 imageOffH:imageOffH direction:imgDirection.boolValue];
        ...
        imageOffH = 0;
        if(maxHeight > 0) imageOffH = maxHeight - image.size.height;
        UIImage * imageSelected = [UIImage createImageWithTitle:title font:font color:color image:image offH:5 imageOffH:imageOffH direction:imgDirection.boolValue];
