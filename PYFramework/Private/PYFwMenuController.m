...
-(void) setMenuStyle:(NSArray<NSDictionary *> *)menuStyle{
    ...
    for (NSDictionary * style in menuStyle) {
        ...
        NSNumber * isDownImgDirection = style[PYFwMenuIsDownImgDirection] ? : @(YES);
        UIImage * imageNormal = [PYFrameworkUtile createImageWithTitle:title font:font color:color image:image offH:5 isDownImgDirection:isDownImgDirection.boolValue];
        ...
        UIImage * imageHigthlight = [PYFrameworkUtile createImageWithTitle:title font:font color:color image:image offH:5 isDownImgDirection:isDownImgDirection.boolValue];
        ...
        UIImage * imageSelected = [PYFrameworkUtile createImageWithTitle:title font:font color:color image:image offH:5 isDownImgDirection:isDownImgDirection.boolValue];
